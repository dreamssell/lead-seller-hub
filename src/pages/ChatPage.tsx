...
import {
  ...
  Database, Activity, ShieldAlert, Wifi, WifiOff, Terminal, ChevronDown, ChevronUp, History as HistoryIcon, Bug, YoutubeIcon, Share2
} from 'lucide-react';
...
const channels: Array<{
  ...
  { key: 'youtube', name: 'YouTube', icon: YoutubeIcon, color: 'text-red-500', bg: 'bg-red-500/10', leads: 22, open: 3 },
